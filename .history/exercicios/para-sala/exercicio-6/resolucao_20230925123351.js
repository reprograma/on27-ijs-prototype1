...
Account.prototype.transferTo = function transferTo(anotherAccount, amount){
    if (amount < this.montante){
        ...
        console.log(`Transferência de R$ ${amount} realizada com sucesso. Seu saldo é R$ ${this.montante}`) throw new Error('Saldo insuficiente para realizar a operação')
    } else{
