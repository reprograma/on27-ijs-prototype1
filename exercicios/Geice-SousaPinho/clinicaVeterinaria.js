...
function AnimaisExoticos( nome, idade, cor, castrado, historico){ 
    this.nome = nome,
    this.idade = idade, 
    this.cor = cor,
    this.castrado = castrado, 
...
//  Todos os animais precisam de um método realizarProcedimento(), que adicione um novo procedimento ao histórico. Cada procedimento é um objeto com tipo e motivo. criar um objeto normal
